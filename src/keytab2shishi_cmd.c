/*
  ...
  gengetopt --unamed-opts=INFILE [OUTFILE] --no-handle-help --no-handle-error --input keytab2shishi.ggo --file-name keytab2shishi_cmd 
...
const char *gengetopt_args_info_purpose = "Read keytab data from INFILE (usually /etc/krb5.keytab) and\nwrite Shishi hostkeys to OUTFILE.  If INFILE and OUTFILE are not\nspecified, use the defaults.";

const char *gengetopt_args_info_usage = "Usage: keytab2shishi [OPTIONS]... [INFILE [OUTFILE]]...";
